...
class UserUpdateForm(forms.ModelForm):
    ...
    city = forms.CharField(max_length=234, required=False)
    postal_code = forms.IntegerField(required=False)
    country = forms.CharField(max_length=342, required=False)
    ...
    def save(self, commit=True):
        ...
        if commit:
            ...
            user_account, creaetd = UserBankAccount.objects.get_or_create(user=user)
